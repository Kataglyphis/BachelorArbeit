...
\nameref{ch:Content2:sec:Rechenaufwand} und Speicherbedarf.
\vfill
...
\begin{itemize}
    ...
    durchwechselnden Texturen verzichten zu müssen. Neben der vorberechneten \nameref{ch:Content1:sec:blue noise} Textur verwenden wir eine weitere \textit{Retarget}-Textur, welche wir erhalten, indem ein Optimierungsproblem 
    mit Hilfe der im  
...
Beleuchtung (den \nameref{ch:Content1:sec:Path Tracer}), dessen Benutzung von quasi-Zufallszahlen, Eigenschaften der \nameref{ch:Content1:sec:blue noise}, 
und die Funktionsweise des in Kapitel \ref{ch:Temporaler Algorithmus} benötigten Algorithmus, das \nameref{ch:Content2:sec:Simulated Annealing}, anschauen.
%% ==============
