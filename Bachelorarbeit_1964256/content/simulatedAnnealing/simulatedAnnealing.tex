Für unseren temporalen Algorithmus (Abschnitt \ref{ch:Temporaler Algorithmus}) gibt es einen 
...
Die günstigen Eigenschaften der Exponentialfunktion \ref{fig:Exponentialfunktion} als
...
Typische Werte für $\alpha$ liegen zwischen 0.8 and 0.99. Abbildung \ref{pic:Cool Down Comparisson}
...
Abbildung \ref{pic:Cool Down Comparisson}
...
Wir wählen die Starttemperatur \ref{pic:Temperaturverlauf kirkpatrick} folgendermaßen, dass anfangs alle Permutationen 
...
\begin{figure}[H]
  ...
  \begin{itemize}
    \item[\ref{pic:dither0}] unsere \nameref{ch:Content1:sec:blue noise} Textur zum Zeitpunkt t=0 
                              haben
    \item[\ref{pic:abkühl_schritt_1}] 
    \item[\ref{pic:abkühl_schritt_2}-\ref{pic:abkühl_schritt_4}] 
    \item[\ref{pic:abkühl_schritt_5}] 
    \item[\ref{pic:abkühl_schritt_6}-\ref{pic:abkühl_schritt_8}]
    \item[\ref{pic:dither1}]  
  \end{itemize}
