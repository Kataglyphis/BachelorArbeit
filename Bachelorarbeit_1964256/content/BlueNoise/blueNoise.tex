...
Eine Ansammlung von Pixeln, deren Verteilung über den Raum einer \nameref{ch:Content1:sec:blue noise} entspricht, 
...
diese Eigenschaft alleine nicht ausreicht und uns zur \nameref{ch:Content1:sec:blue noise:Niedrige Frequenzen} führt.
...
In der Frequenzdomäne \ref{pic:Frequnzdomäne Bayer} ist zu erkennen, das die Amplitudendichte in einzelnen
...
Es empfiehlt sich daher für den \nameref{ch:Temporaler Algorithmus} eine kleinere Textur zu verwenden.
