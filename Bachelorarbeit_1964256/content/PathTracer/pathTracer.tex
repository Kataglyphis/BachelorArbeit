...
\todo{referenz für importance sampling}
...
Deshalb verwenden wir den \nameref{ch:Content1:sec:Path Tracer} um innerhalb unseren 
\ref{pic:Render Graph} die \textit{Global Illumination} zu erreichen. Der hier verwendete \nameref{ch:Content1:sec:Path Tracer} in 
...
ein \nameref{ch:Temporaler Algorithmus} und damit eine direkte Umverteilung im Bildraum verwendet.
